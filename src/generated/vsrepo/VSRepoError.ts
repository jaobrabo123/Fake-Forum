...
export const VSRepoConfigError: typeof VSRepoConfigErrorType =
    VSRepoConfigErrorRuntime;
export const VSRepoBuildError: typeof VSRepoBuildErrorType =
    VSRepoBuildErrorRuntime;
export const VSRepoExtendError: typeof VSRepoExtendErrorType =
    VSRepoExtendErrorRuntime;
export const VSRepoRuntimeError: typeof VSRepoRuntimeErrorType =
    VSRepoRuntimeErrorRuntime;
